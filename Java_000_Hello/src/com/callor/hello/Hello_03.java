...
public class Hello_03 {
	...
	public static void main(String[] args) {
		...
		// 소수점이하 16자리 까지 표현하고 이후 값은 무시 또는 반올림등을 수행한다
		System.out.print("40.0 / 30.0 = ");
		System.out.println(40.0 / 30.0);
		
		// 정수와 실수의 연산
		// 정수와 실수가 섞여있는 연산 식에서는 모든 숫자를 실수로 변경하여 연산이 수행
		System.out.print("40 / 30.0 = ");
		System.out.println(40 / 30.0);
		
		// 숫자 뒤에 f(F)를 부착하면 단축형 실수가 된다. (float)
		// 소수점이하 7째자리까지만 인식한다
		System.out.print("(40.0f = )40F / 30F = ");
