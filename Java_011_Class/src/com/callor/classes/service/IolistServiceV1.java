 ...
 * 데이터의 묶음을 처리할때는 보통 배열을 사용, 하지만 배열은 그 구조상 사용이 다소 불편할때가 많다
 * Java에서는 배열을 사용해야 하는 프로젝트서 List 클래스를 사용한 객체를 생성하여 진행을 한다
 */
public class IolistServiceV1 {
	 ...
	 * 
	 * 낱개 데이터 IolistVO 클래스 형으로 사용하고 그 데이터들을 묶어서 List 형으로 연산수행을 하겠다 선언
	 * 
...
//			int intmenu = scan.nextInt();
	...
	public void printAllList() {
		...
		System.out.println("-".repeat(80));
		System.out.println("상품명\t거래일자\t거래처\t구분\t수량\t매입단가\t매출단가");
		System.out.println("-".repeat(80));
