 ...
 * 		약간의 문제가 발생하여 수정 : V1.1 또는 V1.01
 * 
 * 배포 후에 사용자의 피드백을 받아서 수정하고 재 배포
 * 		V1.xx V1.xy ~
 * 
 * 사용자의 의견을 수렴하여 새로운 프로젝트를 기획, 제작, 배포
 * 		기존 프로젝트 V1, 새로운 기능이 개선(추가)되어 배포된 프로젝트를
 * 		V2.xx 라고 칭하여 배포
 */
...
public class PrimeServiceV1 {
	...
	// 여러(2개이상)의 method에서 공통으로 사용할 변수들은 클래스 영역에 설정을 한다
	// 		변수 사용(참조) : 저장, 읽기
	...
	// method는 첫글자 소문자로 시작하여 변수 이름짓기와 같은 방식으로 이름을 짓는다(camel case)
	// 		Lower Camel Case
