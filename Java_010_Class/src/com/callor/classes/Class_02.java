...
public class Class_02 {
	...
	public static void main(String[] arg) {
		 ...
		 * 		선언할때는 List를 사용하고 생성(초기화)할때는 ArrayList() 생성자 사용
		 * 
		 * List 형 객체를 선언하고 ArrayList()로 생성을 하면 size가 0인
		 * 		배열객체가 생성되는 것과 유사하다
		 */
		...
		// 배열의 값을 저장할때는 원하는 length 만큼 배열을 생성하고
		...
		intList.add(100);	// intList의 size가 1이 되고 자동으로 0번 위치에 100이 저장
		...
		// 위에서 add()를 3번 실행했기 때문에 size는 3이 되고
		//	get(index) 를 수행할때 index 값은 size - 1 까지만 사용할 수 있다.
