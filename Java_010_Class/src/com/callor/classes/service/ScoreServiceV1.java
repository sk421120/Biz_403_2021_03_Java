 ...
 * 		클래스를 상속받게 하겠다 라는 전제하에 상속받은 클래스에서는 자유롭게 접근 가능
 * 
...
public class ScoreServiceV1 {
	...
	/*
	 * 멤버변수를 protected로 선언을 해두면 현재클래스V1 상속받은 자식클래스에서
	 * 변수가 선언된것처럼 동작할 수 있다.
	 * 
	...
	public Integer inputScore() {
		...
		int intKor = 0;
		while (true) {
			System.out.println(strNum + "번의 국어점수를 입력하세요 (종료 : -1)");
			System.out.print(" >> ");
			intKor = scan.nextInt();
			if (intKor == -1) {
				return -1;
	...
	private void printHeader() {
		System.out.println("* 자바 고등학교 성적처리 V1");
		System.out.println(Lines.dLine(55));
		System.out.println(" 학번\t국어\t영어\t수학\t총점\t평균\t석차");
		System.out.println(Lines.sLine(55));
	}
