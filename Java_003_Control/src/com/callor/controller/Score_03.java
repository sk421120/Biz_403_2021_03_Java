...
public class Score_03 {
	...
	public static void main(String[] arg) {
		 ...
		 * 소수점이하 계산을 살리기 위해 평균을 저장할 변수를 float형으로 선언하였다
		 ...
		 * 
		 * 이 명령문을 실행하여 정확한 평균을 계산하기 위해서는 대입연산자 오른쪽에
		 * 계산식의 값들을 실수형으로 강제형변환 한 다음 연산을 수행해야 한다.
		 */
		// 평균을 저장할 변수를 float형으로
		float floatAvg = intSum / 2;
		
		// intSum / 2의 연산시에서 정수형변수 intSum을 float형으로 강제형변환 하면
