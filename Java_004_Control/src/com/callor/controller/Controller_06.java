 ...
 * Lego 블럭을 이용해서 작품을 만드는 것처럼 JDK에 있는 도구들을 사용하여
 * 프로젝트를 만들 수 있다.
 * JDK에 있는 도구는 워낙 종류, 개수가 많아서 한꺼번에 프로젝트에 포함하면
 * 프로젝트가 너무 거대해 질 것이다.
 * 이러한 문제를 방지하기 위하여 Java에서는 가장 기본적인 도구 외에는
 * 모두 파일로 제공하고 필요에 따라 import 하여 사용할 수 있도록 하고 있다.
 * 
 * import java.util.Random;
 * 지금부터 Controller_06 클래스에서 java.util 패키지의 Random 클래스 라는
...
public class Controller_06 {
	...
	public static void main(String[] arg) {
		 ...
		 * 
		 * int 키워드는 정수형 변수를 선언
		 * Integer 키워드는 정수형 변수를 선언, 실체는 키워드가 아니고 class이다
		 * 
		...
		Random rnd1 = new Random(); //선언 및 초기화
