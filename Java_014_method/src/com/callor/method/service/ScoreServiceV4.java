...
public class ScoreServiceV4 {
	...
	// 키보드를 사용하여 3과목의 점수를 입력받는데 InputServiceV2에 선언된 method를 사용할 예정이므로
	...
	public void inputScore() {
		...
		for(int i = 0 ; i < score.length ; i++) {
			 ...
			 * 
			 * return을 실행하면 현재 method(intputScore() )를 무조건 종료해 버린다.
			 * 	inputScore() method를 호출했던 코드로 되돌아간다.
			 */
			if(score[i] == null) {
				return;
			}
			// return 받은 점수를 score배열의 i번째 위치에 저장된다.
			System.out.println("-".repeat(50));
		} // for end
