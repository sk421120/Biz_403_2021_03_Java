...
public class Varriable_03 {
	...
	public static void main(String[] arg) {
		...
		// 	정수값을 저장할 기억장소를 예약하고 num1이름 부여하기
		int num1;
		// 한번 변수를 선언하는데 사용한 이름으로 또 다시 변수를 선언 할 수 없다.
		 ...
		 * 
		 * 변수는 선언할 때 반드시 어떤 값을 저장해주는것이 좋다.
		 * 
		 * 만약 저장될 값이 정해지지 않았다면 0을 저장(숫자일 경우)
		 */
		// 정수형 값을 저장할 변수 num3를 선언하고 0으로 clear 한다.
		// ==> 변수선언과 초기화 ==> 변수생성 이라고 한다.
		int num3 = 0;
