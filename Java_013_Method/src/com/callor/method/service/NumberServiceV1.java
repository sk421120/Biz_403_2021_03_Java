...
public class NumberServiceV1 {
	 ...
	 * 	생성한 수가 1~100까지 정수형 난수 3의 배수이면서 정수인 값을 return 하라
	 * 	정수형 3의 배수를 return 하라
	 * 
	 * return type을 void가 아닌 정수형 type으로 지정해야 한다
	 * 	int와 Integer 가 있다.
	 * 
	 * return 의 두번째 조건에 "아니면 null값을 return"하라는 지시가 있으므로
	 * 	int 형은 사용할 수 없다.
	 * 
	 * void 키워드
	 ...
	 * 	Integer 형 return type을 설정해야 한다. void 대신 Integer를 사용해야 한다
	 * 
	...
	public Integer inputNum() {
		...
		System.out.println("생성된 난수는 " + num1);
		System.out.println("-".repeat(40));
