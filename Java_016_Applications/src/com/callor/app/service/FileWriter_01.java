...
public class FileWriter_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 	Copy Qualified를 사용하여 임의 파일 이름을 가져오고 필요한 파일로 이름을 변경하여 사용.
		 */
		...
		// 객체 생성
		// FileWriter 클래스를 객체로 생성할때 만들(작성할, 새로생성할)
		// 	파일이름(경로포함)을 생성자 매개변수로 전달해 주어야 한다.
		try {
			// FileWriter 클래스의 객체만으로 파일에 기록할 수 있지만
			...
			// OS <-> FileWriter <-> PrintWriter가 서로 연결되어 데이터 파일에 기록한다.
			...
			// PrintWriter 닫으면 FileWriter도 같이 닫히기 때문에 close하지 않아도 무방하다
