...
public class Student_01A {
	public static void main(String[] args) {
		...
		// PrintWriter, BufferedReader : 내용을 쓰고, 읽고
		...
		try {
			 ...
			 * 3. 무한반복 조건을 부여하여 탈출구를 만들 때 일반적으로 쉽게 구현할 수 잇는 코드
			 * 4. if() 조건문이 필요하고 때로는 추가되는 코드가 필요하다
...
//				System.out.println(reader);
			...
			/* =====================================================
			 *  while(조건식) 무한반복문
			 *  1. 무한반복코드가 중단되는 조건이 한개만 있을경우 사용
			 *  2. 조건식을 어떻게 만들것인가 잘 구상해야 한다
			 *  3. while(조건식)이 시작되기 전에 최초에 조건이 true가 되도록 만들어야 한다.
			 *  4. 적절하게 탈출을 하려면 코드내에서 조건식이 false 되도록 연산을 수행해야 한다.
			 *  5. 코드내에서 조건이 false가 되더라도 이후의 명령들이 한번씩 실행되고 나서 탈출이 이루어 진다
			 */
			// 문자열 변수 reader를 null이 아닌 값으로 생성하기
			String reader = new String();
			
			// 최초에 while()문에서 reader != null은 true가 아닐때
			// reader = buffer.readLine()을 실행하고 reader 저장된 값이 null인지 비교한다
...
//				System.out.println(reader);
				...
				// students 배열은 자동으로 분해된 문자열 수만큼 생성이 되고
				// 각 요소에 값이 저장된다.
